			...
			<section className='jumbotron jumbotron-fluid'>
				<div className='container'>
					...
					<p className='lead mb-5'>
						...
						eros quis sem placerat ultricies et id ipsum. Aliquam sollicitudin
						maximus nulla vel ultrices. Vivamus pulvinar semper neque, sed
						convallis nisi ultrices quis
					</p>
					<HeroSearch />
				</div>
			</section>
